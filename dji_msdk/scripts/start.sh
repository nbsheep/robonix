#!/usr/bin/env bash
# dji_msdk 启动脚本 —— 由 rbnx boot 调用，启动 RoboNIX 原语驱动。
#
# 环境变量：
...
# ============================================================
# 2. 解析 RC Pro 地址（manifest config 优先，环境变量覆盖）
# ============================================================
...
echo "[dji_msdk] RC Pro: ${RC_PRO_IP}:${RC_PRO_PORT}"
echo "[dji_msdk] Atlas:  ${RBNX_ATLAS:-auto}"
...
# 4. 启动 RoboNIX 原语驱动
# ============================================================
exec python3 -u -m dji_msdk.driver
